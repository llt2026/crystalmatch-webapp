...
export default function AnnualBasicReport() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-950 to-purple-900 text-white p-4">
      ...
      {/* Energy Calendar - Show all four columns but lock Crystal and Lucky Colors */}
      <div className="mb-8">
                ...
                >
                  ...
                  <td className="py-3 px-4 text-gray-400">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-400">Plus members only</span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-gray-400">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-400">Pro members only</span>
                    </div>
                  </td>
                </tr>
              ))}
      ...
      <div className="rounded-lg bg-gradient-to-r from-purple-700 to-indigo-700 p-6 text-center backdrop-blur-sm border border-purple-600/50">
        <h2 className="text-xl md:text-2xl font-semibold mb-4">Unlock More Personalized Content</h2>
        <p className="mb-6">Upgrade to Plus for monthly crystal recommendations and detailed guidance</p>
