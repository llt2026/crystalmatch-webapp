...
exports.ZODIAC_MAP = exports.FIVE_ELEMENTS_MAP = void 0;
exports.calculateSimpleBazi = calculateSimpleBazi;
// 天干
const TIAN_GAN = ['甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸'];
// 地支
const DI_ZHI = ['子', '丑', '寅', '卯', '辰', '巳', '午', '未', '申', '酉', '戌', '亥'];
// 干支对应的五行
exports.FIVE_ELEMENTS_MAP = {
    '甲': 'wood', '乙': 'wood',
    '丙': 'fire', '丁': 'fire',
    '戊': 'earth', '己': 'earth',
    '庚': 'metal', '辛': 'metal',
 ...
 * @returns 天干地支索引
 */
function getLunarMonthGanZhi(yearGan, month) {
    // 计算月干的起始值(以寅月为正月)
    // 甲己年: 丙寅 -> 2
    // 乙庚年: 戊寅 -> 4
    // 丙辛年: 庚寅 -> 6
 ...
 * @returns 天干地支索引
 */
function getSolarDayGanZhi(year, month, day) {
 ...
 * @returns 八字信息
 */
function calculateSimpleBazi(year, month, day) {
    // 计算年柱
    ...
    // 获取生肖
    const zodiac = exports.ZODIAC_MAP[yearZhi];
    return {
        tianGan: {
            year: yearGan,
            month: monthGan,
